...
def get_ai_recommendation(context):
    ...
    llm_payload = {
        ...
        "messages": [
            {"role": "system", "content": "You are an AI assistant helping hybrid workers decide where to work based on their meeting schedule, weather conditions and traffic.In case traffic data is missing, dont mention it to the user.Consider the other parameters"},
